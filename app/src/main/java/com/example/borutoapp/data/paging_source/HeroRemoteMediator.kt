...
class HeroRemoteMediator @Inject constructor(
    ...
    private val heroRemoteKeysDao = borutoDatabase.heroRemotesKeyDao()
    ...
    override suspend fun load(loadType: LoadType, state: PagingState<Int, Hero>): MediatorResult {
        return try {
            val page = when (loadType) {
                LoadType.REFRESH -> {
                    val remoteKeys = remoteKeyClosesToCurrentPosition(state)
    ...
    private suspend fun remoteKeyForLastItem(state: PagingState<Int, Hero>): HeroRemoteKeys? {
    ...
    private suspend fun remoteKeyForFirstItem(state: PagingState<Int, Hero>): HeroRemoteKeys? {
    ...
    private suspend fun remoteKeyClosesToCurrentPosition(state: PagingState<Int, Hero>): HeroRemoteKeys? {
